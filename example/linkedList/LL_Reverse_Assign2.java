...
//			_ln3_ = _ln1_;
			//
//			_ln1_ = _ln2_;
			_BLOCK_(SketchRequest.queryBlock(ln1.getClass(), new String[] { "ln1", "ln2", "ln3", "ln4" },
					new Entry[] { _ln1_, _ln2_, _ln3_, _ln4_ }, 5, 1, 0));
					// _ln2_ = _ln4_;
...
//		 _ln1_.next = _ln3_;
//		_BLOCK2_(SketchRequest.queryBlock(ln1.getClass(), new String[] { "head", "ln1","ln3" }, new Entry[] { head, _ln1_,_ln3_ },
//				2, 1, 1));
//		 head = _ln1_;
		return this;
	}
